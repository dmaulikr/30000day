...
//    CGContextStrokePath(ctx);
    ...
    // 进度环
    [[UIColor colorWithRed:109.0/255 green:157.0/255 blue:234.0/255 alpha:1.0] set];
    ...
    CGFloat maskW = (radius - FriendProgressHeight) * 2;//进度条圈圈的厚度
    CGFloat maskH = maskW;
...
//    CGContextStrokePath(ctx);
    ...
    [self setCenterProgressText:@"" withAttributes:attributes];
}
