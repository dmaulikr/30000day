...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    NSString *dateString=[NSString stringWithFormat:@"%ld-12-31",[dateComponent year]-100];
    NSDateFormatter *dateFormatter=[[NSDateFormatter alloc]init];
    [dateFormatter setDateFormat:@"yyyy/MM/dd"];
    NSDate *mindate=[dateFormatter dateFromString:dateString];
    
    NSString *dateString1=[NSString stringWithFormat:@"%ld-%ld-%ld",(long)[dateComponent year],[dateComponent month],[dateComponent day]];;
    NSDateFormatter *dateFormatter1=[[NSDateFormatter alloc]init];
    [dateFormatter1 setDateFormat:@"yyyy/MM/dd"];
    NSDate *maxdate=[dateFormatter1 dateFromString:dateString1];
...
-(void)setMaxMinYer
{
    ...
    [offsetCom setYear:-100];
    [offsetCom setMonth:0];
    [offsetCom setDay:0];
    NSDate* mindate=[gregorian dateByAddingComponents:offsetCom toDate:[NSDate date] options:0];
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        _resultString = [formatter stringFromDate:date];
