...
- (void)setFactorModel:(GetFactorModel *)factorModel {
    ...
    [self.setButton setTitleColor:[Common isObjectNull:factorModel.userSubFactorModel.factor] ? LOWBLUECOLOR : [UIColor darkGrayColor] forState:UIControlStateNormal];
}
