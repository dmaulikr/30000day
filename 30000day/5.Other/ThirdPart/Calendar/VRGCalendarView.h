...
#define kVRGCalendarViewDayWidth (SCREEN_WIDTH - 14.0f)/7.00f
#define kVRGCalendarViewDayHeight (SCREEN_WIDTH - 14.0f)/7.00f
...
@property (nonatomic,assign) BOOL isFirstInit;//是否是第一次初始化
