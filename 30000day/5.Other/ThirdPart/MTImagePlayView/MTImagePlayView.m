...
@property (nonatomic, assign) BOOL isHandsScroll;
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    int curPage = (int)(scrollView.contentOffset.x / scrollView.frame.size.width + 0.5);
    self.pageControl.currentPage = curPage;
    
}

//这个还是有点用处的，手动滚动视图时让pagecontrol不会从最后一个滚动第一个
